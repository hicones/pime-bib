export const RestaurantsBackground = () => {
  return (
    <section className="restaurantsBackground -z-10 flex items-center justify-center bg-[url(/bg-destaques.png)]">
      <div>
      ...
      <span className="font-normal grotesk absolute bottom-5 w-full text-center lg:text-[2rem] md:text-2xl text-base uppercase">
        DESCUBRA RESTAURANTES & CAFETERIAS
      </span>
    </section>
  );
};
