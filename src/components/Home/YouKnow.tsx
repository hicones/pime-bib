...
export const SectionYouKnow = () => {
  ...
  return (
    <section className="flex flex-col w-full lg:min-h-screen min-h-[50dvh]  md:h-screen lg:justify-between justify-center items-center px-4 pt-4 gap-8 ">
      <div
        ref={ref}
      ...
      <hr className="w-2 bg-main-100 h-32" />
    </section>
  );
};
